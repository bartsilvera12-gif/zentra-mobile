...
import CampanasDetailClient from "../[id]/CampanasDetailClient";

export type CampanaDetalleModalProps = {
  id: string | null;
  open: boolean;
  onClose: () => void;
};
    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-3 sm:p-6">
      ...
      >
        ...
        <div className="min-h-0 flex-1 overflow-y-auto bg-slate-50/50 px-5 py-5">
          <CampanasDetailClient campaignId={id} variant="modal" onClose={requestClose} />
        </div>
      </div>
    </div>
  );
