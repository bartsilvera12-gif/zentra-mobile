...
export type UsuarioNuevoModalProps = {
  open: boolean;
  onClose: () => void;
  onCreated?: () => void;
};

export default function UsuarioNuevoModal({ open, onClose, onCreated }: UsuarioNuevoModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-0 sm:p-4 md:p-6">
      ...
      <div
        role="dialog"
        aria-modal="true"
        aria-labelledby="usuario-nuevo-titulo"
